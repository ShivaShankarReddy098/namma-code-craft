...
import { Code2, Palette, Search, RefreshCw, Smartphone, Zap, Shield, Headphones } from "lucide-react";
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ["Legacy Migration", "Modern Framework", "Performance Optimization", "Mobile Responsive"],
    ...
    },
    {
      ...
      features: ["Speed Optimization", "Core Web Vitals", "Caching Strategy", "CDN Setup"],
      price: "Starting at $1,299",
    },
    {
      icon: Shield,
      title: "Security & Maintenance",
      description: "Keep your website secure and up-to-date with our comprehensive maintenance services.",
      features: ["Security Monitoring", "Regular Updates", "Backup Management", "24/7 Support"],
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { step: "02", title: "Planning", description: "We create a detailed project plan and timeline for execution." },
              { step: "03", title: "Development", description: "Our team brings your vision to life with clean, efficient code." },
              { step: "04", title: "Launch", description: "We deploy your project and provide ongoing support and maintenance." },
            ].map((process, index) => (
              <div 
                key={process.step} 
