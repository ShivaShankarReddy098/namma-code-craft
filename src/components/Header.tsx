  ...
  <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-16">
      ...
      <Link to="/" className="flex items-center space-x-2 group">
        <div className="p-1 bg-black/30 rounded-full group-hover:scale-110 transition-transform duration-200 backdrop-blur-sm">
        ...
        <span className="text-2xl font-bold font-playfair text-black w-[150px] text-center block">
          <span className="text-foreground">{name}</span> Code
        </span>
      </Link>
      ...
      <div className="md:hidden">
        <button
          ...
          className="p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent/30"
        >
          {isMenuOpen ? (
            <X className="h-6 w-6" />
          ) : (
